    ...
    try {
        ...
        jsonData.routes.forEach(route => {
            ...
            if (route.routeType == "Subway") {
                if (route.route == "1") {lineIdx = 0;}
                ...
                else if (route.route == "5") {lineIdx = 4;}
                else if (route.route == "6") {lineIdx = 5;}
                else {
                    ...
                    else if (description.includes("Line 5")) { lineIdx = 4; }
                    else if (description.includes("Line 6")) { lineIdx = 5; }
                }
            }
            else if (route.routeType == "LRT") {
                if (route.route == "5") {lineIdx = 4;}
                else if (route.route == "6") {lineIdx = 5;}
                else {
                    if (description.includes("Line 5")) { lineIdx = 4; }
                    else if (description.includes("Line 6")) { lineIdx = 5; }
                }
            }
        ...
        jsonData.accessibility.forEach(access => {
            ...
            if (access.routeType == "Elevator") {
                ...
                else if (access.route.split(",").includes("5")) {lineIdx = 4;}
                else if (access.route.split(",").includes("6")) {lineIdx = 5;}
                else {
                    if (description.includes("Line 1")) { lineIdx = 0; }
                    else if (description.includes("Line 2")) { lineIdx = 1; }
                    else if (description.includes("Line 4")) { lineIdx = 3; }
